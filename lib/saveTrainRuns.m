%already modified by Qun, but I think it is uselessness.
...
%cpFiles = dir([prefix 'chkpt_*' pathPart{end}]);%QUN
cpFiles = dir([prefix pathPart{end}]);
%N = numel(cpFiles); %QUN
N=1;
...
for k = 1:N
  ...
  trainInfo = load('modelfile_log_1.mat');
